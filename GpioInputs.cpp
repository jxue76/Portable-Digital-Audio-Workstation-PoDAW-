/*
This file implements the GpioInputs class, which implements the Inputs interface to read button states from GPIO pins. 
It uses the libgpiod library with cpp bindings to interact with the GPIO hardware, and threads to detect dial movements.
*/
...
// Pull all inputs active low, start dial thread
